...
(function () {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        let firstTime = true;
        const POST_SELECTOR = '[data-testid="mainFeed"] > div[data-lazy-mount-id]';
        const CARD_CLASS = "card";
        const SPECIES_ATTRIBUTE = "data-companion-species";
        let userOption = yield browser.storage.local.get(["hide", "imageCategory", "singlePostMode"]);
        if (!Object.prototype.hasOwnProperty.call(userOption, "hide")) {
            yield browser.storage.local.set({ "hide": true });
            userOption = (yield browser.storage.local.get(["hide", "imageCategory", "singlePostMode"]));
        }
        const category = (_a = userOption.imageCategory) !== null && _a !== void 0 ? _a : "both";
        const singlePostMode = (_b = userOption.singlePostMode) !== null && _b !== void 0 ? _b : false;
        ...
        function removeContent() {
            ...
            const contents = document.querySelectorAll(POST_SELECTOR);
        ...
        function isDarkMode() {
            var _a;
            return ((_a = document.querySelector('[data-color-scheme]')) === null || _a === void 0 ? void 0 : _a.getAttribute("data-color-scheme")) === "dark";
        }
        ...
        function themeChanger(theme, companion) {
